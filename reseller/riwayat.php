                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Riwayat</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="index.php">Home</a>
                                  <span class="brd-separetor">/</span>
                                  <span class="breadcrumb-item active">Riwayat</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-content table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        $ambil = $koneksi->query("SELECT * FROM transaksi  WHERE id_pelanggan = '$id'");
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-remove" ><a href="detail_transaksi.php?id=<?php echo $pecah['id_pembelian']; ?>">Detail</a></td>
                                        </tr>
