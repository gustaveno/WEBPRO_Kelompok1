            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-6 col-sm-12">
                      ...
                      $koneksi = mysqli_connect("localhost","root", "", "tubes2");
                      $id = $_GET['id'];
                      $sql = mysqli_query($koneksi, "SELECT * FROM products  WHERE product_id = '$id'");
                            ...
                            <div class="product__big__images">
                                <div class="portfolio-full-image tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="img-tab-1">
                                        <img src="../admin/upload/product/<?php echo $data['image']; ?>" width="500px" height="500px">
                                    </div>
                    ...
                    <div class="col-md-12 col-lg-6 col-sm-12 smt-30 xmt-30">
                        <div class="htc__product__details__inner">
                            ...
                            <div class="prodict-statas"><span>STOK : <?php echo $data['stok']; ?></span></div>
                            
                            
                            <ul class="pro__dtl__prize">
                                <li>RP.<?php echo number_format( $data['price'], 0,',','.'); ?></>
                            </ul>
                                    ...
                                    <form  method='POST'>
                                        <div class="product-quantity">
                                            <div class="cart-plus-minus">
                                                <input class="cart-plus-minus-box" type="number" min="1" max="<?php echo $data['stok']; ?>" type="text" name="jumlah" value="1">
                                            </div>
                                        </div>
                                    
                                </div>
                            </div>
                                <button class="btn btn-outline-danger" name="beli">Beli sekarang</button>
                        </div>
                        </form>
                        <?php
                        if(isset($_POST['beli'])){
                        ...
                        <div class="modal-product">
                            ...
                            <div class="product-images">
                                <div class="main-image images">
                                    <img alt="big images" src=img src="../admin/upload/images/product/3.jpg">
                                </div>
                            </div>
                            <!-- end product images -->
