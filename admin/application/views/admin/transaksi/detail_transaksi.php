							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									foreach ($laporan as $laporan):
										$subtotal = $laporan->jumlah * $laporan->harga;
										$total += $subtotal;
									?>

									<tr>
										<td><?php echo $laporan->id_produk ?></td>
										<td><?php echo $laporan->nama ?></td>
										<td>
											<img src="<?php echo base_url('upload/product/'.$laporan->foto) ?>" width="64" />
										</td>
										<td><?php echo $laporan->jumlah ?></td>
										<td><?php echo number_format($laporan->harga,0,',','.') ?></td>
