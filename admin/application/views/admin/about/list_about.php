			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<!-- <a href="<?php echo site_url('admin/about/add') ?>"><i class="fas fa-plus"></i> Tambah about</a> -->
					</div>
					<div class="card-body">
						...
						<div class="table-responsive">
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										<td width="150">
											<?php echo $about->judul ?>
										</td>

										<td>
											<img src="<?php echo base_url('upload/about/'.$about->gambar) ?>" width="64" />
										</td>
										<td>
